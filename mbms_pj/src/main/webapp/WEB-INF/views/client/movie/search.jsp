            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <span style="text-transform: capitalize;">Search</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="product__page__content">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-6">
                                    <div class="section-title">
                                        <h4 style="text-transform: uppercase;">search : ${keyword }</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
	                        <c:choose>
	                    		...
	                    		<c:otherwise>
			                    	<c:forEach var="movieDTO" items="${searchList }">
	                    		...
	                    		<c:otherwise>
			                    	<c:forEach var="movieDTO" items="${movieList }" begin="0" end="5">
				                    	...
				                    	<div class="product__sidebar__view__item set-bg mix ${change }"
	                                		...
	                                		<h5><a href="${contextPath }/movie/detail?movieCd=${movieDTO.movieCd}">${movieDTO.movieNm }</a></h5>
	                            		</div>
			                    	</c:forEach>
	                    		</c:otherwise>
	                    	</c:choose>
